...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   calculate_collision_grid.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ihashimo <ihashimo@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/29 14:29:28 by ihashimo          #+#    #+#             */
/*   Updated: 2023/08/29 14:29:29 by ihashimo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static double	calculate_camera_location(int x, int width)
{
	double	camera_x;
