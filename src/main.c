...
int input_key(int keycode, t_game *game)
{
	...
	{
		printf("back\n");
		if (!game->world_map[(int)(game->player->position_x - game->player->direction_x * game->player->move_speed)][(int)(game->player->position_y)])
			game->player->position_x -= game->player->direction_x * game->player->move_speed;
		if (!game->world_map[(int)(game->player->position_x)][(int)(game->player->position_y - game->player->direction_y * game->player->move_speed)])
			game->player->position_y -= game->player->direction_y * game->player->move_speed;
	}
